...
> &emsp;&emsp;&emsp; 2. Open it and **Right Click** inside the folder.  
> &emsp;&emsp;&emsp; 3. If the Git did not show up, you will need to click **show more options**.  
...
2. Go to the **directory** of that folder located at the top.
3. Click the directory, type **cmd**, then enter. A Command Prompt will pop up.
...
6. Once you have clicked it, a Terminal will show up below. You will see the word **powershell** at the top right of the terminal. Click this **v** button and choose **Git Bash**.
...
5. Once you have created a repository, open your VS Code following the steps earlier. Right click in this area and create a **new file**. Then name it **README.md**. This will be needed when setting up Github.
6. After creating the README file, open your github account, then locate the **Github setup commands**.
7. **Copy, paste, then enter one-by-one** this commands in the git bash terminal.
8. Once you are done, reload your Github and you're finished setting it up.